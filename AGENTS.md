...
- The homepage portrait remains the current natural-color `egor-hero-cutout` asset. On desktop, keep Egor slightly larger and grounded at the bottom of the HERO; on 320–520px mobile screens, use the compact upper-right portrait composition established by the 404 page instead of a tall standalone image block.
