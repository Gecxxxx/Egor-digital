...
const serviceRows = [
  ["01", "Сайт для бизнеса", "Лендинг или многостраничный сайт: структура, дизайн, адаптив, формы заявок и аналитика.", "от 50 000 ₽"],
  ["02", "Сайт + CRM", "Сайт, заявки, статусы, ответственные и история общения в единой системе.", "от 100 000 ₽"],
  ["03", "Полный аудит и доработка", "Разбираю структуру, доверие, мобильную версию, формы и аналитику, затем исправляю приоритетные проблемы.", "от 25 000 ₽"],
  ["04", "CRM / автоматизация", "Клиенты, источники, статусы, уведомления, интеграции и отчёты в одной системе.", "от 120 000 ₽"],
